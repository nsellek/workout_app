...
ActiveRecord::Schema[7.0].define(version: 2023_09_27_223629) do
  ...
  create_table "trainer_widgets", force: :cascade do |t|
    t.integer "trainer_id"
    t.integer "widget_id"
    t.integer "position"
    t.jsonb "settings", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["trainer_id"], name: "index_trainer_widgets_on_trainer_id"
    t.index ["widget_id"], name: "index_trainer_widgets_on_widget_id"
  end
